...
const socialHover = { borderColor: 'var(--cyan)', color: 'var(--cyan)' }
    ...
    <footer style={{
      ...
      <div style={{ display: 'flex', gap: 8 }}>
        {SOCIALS.map(({ label, icon, href }) => (
          <HoverLink key={label} href={href} ariaLabel={label} baseStyle={socialBase} hoverStyle={socialHover}>
            {icon}
          </HoverLink>
        ))}
      </div>
