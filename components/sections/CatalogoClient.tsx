...
const CONSULTAS: Consulta[] = [
  ...
  },
  {
    ...
    descCurta: 'Videochamada de 50 minutos. A gente olha junto, você pergunta, eu respondo. Sem roteiro, sem filtro.',
    ...
    exemplos: [
      'Quero poder perguntar e interagir durante a leitura, não só receber um texto.',
  ...
  },
  {
    num: '// 004',
    nome: 'Mapa Anual',
    subtitulo: 'tiragem anual · 12 cartas',
    descCurta: 'Uma tiragem pensada pro ano inteiro. Mês a mês, o que as cartas sinalizam pra cada ciclo.',
    descLonga: 'Doze cartas, uma por mês. Eu leio cada uma no contexto do seu momento de vida atual e entrego um documento completo com as energias, os temas centrais e os pontos de atenção de cada período. Ideal pra quem quer ter um norte sem ficar dependente de tiragem toda semana.',
    exemplos: [
      'Quero me planejar melhor e entender as energias de cada mês.',
      'Estou num ano de transição grande e quero ter clareza sobre o ritmo disso.',
      'Nunca fiz uma leitura longa e quero experimentar esse formato.',
    ],
    precoBRL: 347,
  },
  {
    ...
    descLonga: 'Às vezes o que você precisa não cabe num formato fixo. Talvez seja uma leitura pra duas pessoas, uma combinação de tiragens, um tema muito específico ou um ritual de fechamento de ciclo. Me conta o que você tem em mente e eu te digo se consigo e quanto fica.',
    exemplos: [
      'Quero fazer uma leitura conjunta com uma amiga sobre a nossa sociedade.',
      'Preciso de duas tiragens diferentes sobre a mesma situação.',
